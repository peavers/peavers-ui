...
local talentData = {
	...
	["mage"] = {
		...
		["frost"] = {
			...
			["MythicPlus"] = {
				talentString = "CAEAAAAAAAAAAAAAAAAAAAAAAYGbmtZBz4BmZWAmZmGjZGzYwwMMzMzMzMzMzMzYmZGzAAAAzMbLLLzMtBAAAAAAbAAAAAAAAA",
				dps = "1,579.9k",
				keystone = "+16"
			},
		},
	...
	["monk"] = {
		...
		["windwalker"] = {
			["MythicPlus"] = {
				talentString = "C0QAAAAAAAAAAAAAAAAAAAAAAMzYmBzYmZWmZgBAAAAAAAAAAAssMMamZGYGGWYYbmZGmFmZwyMBAwyMzwMzY2mBAwGAYWmlmZmZBA",
				dps = "1,459.3k",
				keystone = "+15"
			},
			["Raiding"] = {
