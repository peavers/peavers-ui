...
local talentData = {
	["warrior"] = {
		...
		["protection"] = {
			...
			["MythicPlus"] = {
				talentString = "CkEAAAAAAAAAAAAAAAAAAAAAAYEDAAAAzMzMmxMmZZmlZmZ2wYYaMGjZAmlBG2YmZYYGDDAAAAAAwMDAYZbDwwAbwyiRjZAMbgZ2A",
				dps = "783.3k",
				keystone = "+16"
			},
		},
	...
	["shaman"] = {
		["elemental"] = {
			["MythicPlus"] = {
				talentString = "CYQAAAAAAAAAAAAAAAAAAAAAAAAAAAAYbWWmZmZGzysNzAMjZAAAAAAYzMG2gFYGGasBAmtpZAbMmJMzMz2wyMmxmZZsYZmZGMjZ2GDA",
				dps = "1,391.4k",
				keystone = "+13"
			},
			["Raiding"] = {
