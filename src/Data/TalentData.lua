...
local talentData = {
	...
	["rogue"] = {
		...
		["outlaw"] = {
			["MythicPlus"] = {
				talentString = "CQQAAAAAAAAAAAAAAAAAAAAAAAAMwwYmZwMzwMMMzMzMjZmplZMLzAAAAAAgtlZmhHYmZswMLzyAAAAYMDwAbwMGNmNAbDMmB",
				dps = "1,462.6k",
				keystone = "+14"
			},
			["Raiding"] = {
	...
	["priest"] = {
		["holy"] = {
			...
			["MythicPlus"] = {
				talentString = "CEQAAAAAAAAAAAAAAAAAAAAAAwYAAAAAAAYZYGLPwgZmZMwMmhxyMzsMAAAAAWmthlZmBWYWmxMjBLsxMzUzCAmZBLEGzyAMWgB",
				dps = "192.0k",
				hps = "672.3k",
				keystone = "+13"
			},
	...
	["mage"] = {
		...
		["fire"] = {
			...
			["MythicPlus"] = {
				talentString = "C8DAAAAAAAAAAAAAAAAAAAAAAYGLmNLYGmZ28AwMDTjZmlZGAAAAAADAYmZaZWWmBAYMzMmZYGzMjlZMzw8A2mZ2mxiBAAAAAAAA",
				dps = "1,535.8k",
				keystone = "+15"
			},
		},
	...
	["druid"] = {
		...
		["restoration"] = {
			["MythicPlus"] = {
				talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAsxMzYjZmZmFz2AMLLstMmBAAAAAAAAAAAwyghZGY0MMzMmhZmB0GAAAAAADAgZAAAAAgZbmtmlZ2MMzMwMG",
				dps = "271.8k",
				hps = "730.8k",
				keystone = "+16"
			},
